...
def draw_circuit(pair):
    ...
    with schemdraw.Drawing(backend='matplotlib', scale=0.7) as d:
...
st.write("""
    ...
    * **Phase Control:** By varying the firing angle(α), the average output DC voltage is precisely controlled.
    """)
